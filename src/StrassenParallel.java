 ...
 */
 ...
 public class StrassenParallel {
    ...
    public static int[][] strassen(int[][] A, int[][] B, boolean useThreading) throws InterruptedException {
        int n = A.length;
        if (n == 1) {
        ...
        if (useThreading) {
            ...
            M1 = strassen(MatrixFunction.add(A11, A22), MatrixFunction.add(B11, B22), false);
            M2 = strassen(MatrixFunction.add(A21, A22), B11, false);
            M3 = strassen(A11, MatrixFunction.subtract(B12, B22), false);
            M4 = strassen(A22, MatrixFunction.subtract(B21, B11), false);
            M5 = strassen(MatrixFunction.add(A11, A12), B22, false);
            M6 = strassen(MatrixFunction.subtract(A21, A11), MatrixFunction.add(B11, B12), false);
            M7 = strassen(MatrixFunction.subtract(A12, A22), MatrixFunction.add(B21, B22), false);
        }
